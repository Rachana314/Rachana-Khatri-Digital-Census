...
export default function Forms() {
  ...
  // ✅ because one user can only have one household
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-end justify-between flex-wrap gap-3">
        ...
        {/* ✅ hide new button when user already has one */}
        {!hasForm && (
          <Link
        ...
        <div className="rounded-3xl bg-white border shadow-sm overflow-hidden">
          ...
          {filtered.length === 0 ? (
            ...
            <div className="divide-y">
              {filtered.map((f) => {
                const canDelete = f.status !== "verified"; // delete until verified
                ...
                return (
                  <div key={f.householdId} className="p-5 flex items-start justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      ...
                      {(f.status === "draft" || f.status === "rejected" || f.status === "submitted") && (
                        <Link
